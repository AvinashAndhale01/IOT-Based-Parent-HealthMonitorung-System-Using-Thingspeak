...
float calculateSpO2() {
    ...
    // Ensure the irValue is not zero to avoid division by zero
    if (irValue == 0) {
        return 0.0;
    }

    // Calculate the ratio of red and infrared light intensities
    float ratio = (float)redValue / (float)irValue;

    // Empirical calibration constants, you may need to adjust these
    float a = 112.0;
    float b = -1.22;
